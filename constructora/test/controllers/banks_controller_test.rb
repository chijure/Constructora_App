...
class BanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank" do
    assert_difference('Bank.count') do
      post banks_url, params: { bank: { IdBank: @bank.IdBank, IsActive: @bank.IsActive, Name: @bank.Name } }
    end
  ...
  test "should update bank" do
    patch bank_url(@bank), params: { bank: { IdBank: @bank.IdBank, IsActive: @bank.IsActive, Name: @bank.Name } }
