...
class QuotationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post quotations_url, params: { quotation: { IdQuotation: @quotation.IdQuotation, IdRequestQuotation: @quotation.IdRequestQuotation, Price: @quotation.Price, QuotationDate: @quotation.QuotationDate, Status: @quotation.Status, ValidFor: @quotation.ValidFor } }
    end
  ...
  test "should update quotation" do
    patch quotation_url(@quotation), params: { quotation: { IdQuotation: @quotation.IdQuotation, IdRequestQuotation: @quotation.IdRequestQuotation, Price: @quotation.Price, QuotationDate: @quotation.QuotationDate, Status: @quotation.Status, ValidFor: @quotation.ValidFor } }
